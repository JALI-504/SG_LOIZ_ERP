...
<body>
    ...
    <div class="botones">
        ...
        <a href="{{ route('ventas.cuentas-por-cobrar') }}" class="btn">
            Volver
        </a>
    </div>
                ...
                <tr>
                    <td colspan="2">
                        ...
                        @if ($pago->venta->cliente)
                            {{ trim($pago->venta->cliente->primer_nombre . ' ' . $pago->venta->cliente->segundo_nombre . ' ' . $pago->venta->cliente->primer_apellido . ' ' . $pago->venta->cliente->segundo_apellido) }}

                            @if ($pago->venta->cliente->dni)
                                | DNI: {{ $pago->venta->cliente->dni }}
                            @endif

                            @if ($pago->venta->cliente->telefono)
                                | Tel: {{ $pago->venta->cliente->telefono }}
                            @endif
                        @else
                            Consumidor final
                        @endif
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-right">
                            L {{ number_format($pago->venta->total, 2) }}
                        </td>
                    </tr>
